...
from thesisfolder.methods import DotDict, load_checkpoint, accuracy, posteval, visual_heatmap_compare, camblur_CIFAR10, fullvanillablurrun
import wandb
...
config = { "student": params.model_version, "teacher": "None", "batch_size": 64, 'experiment': 'TopClass','layer_cam': params.cam_layer}
...
runname = runname_model +"_vanilla_layercam" + str(params.cam_layer)
#print(f"current configuration: {config}")
fullvanillablurrun(runname = runname, projectname="blurmaskruns", config=config ,params = params, train_dl = train_dl, val_dl = val_dl)
